...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    COLDEST_ICE("coldest", 26, new int[]{ 5, 7, 5, 4 }, 25,
    SoundEvents.ARMOR_EQUIP_GOLD, 1f, 0f, () -> Ingredient.of(ModItems.COLDEST_ICE.get()));
    ...
    public String getName() {
        return DimensionMod.MOD_ID + ":" + this.name;
    }
