...
public class OrangeVillagerEntity extends PathfinderMob implements Npc {

    public OrangeVillagerEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
