...
public class OrangeVillagerJuiceEntity extends PathfinderMob implements Npc {

    public OrangeVillagerJuiceEntity(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
