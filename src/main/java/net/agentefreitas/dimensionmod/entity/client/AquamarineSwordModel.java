...
public class AquamarineSwordModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition aquamarine_sword = body.addOrReplaceChild("aquamarine_sword", CubeListBuilder.create(), PartPose.offset(0.0F, -15.0F, 0.0F));
		...
		PartDefinition blade = aquamarine_sword.addOrReplaceChild("blade", CubeListBuilder.create().texOffs(14, 7).addBox(0.0F, -21.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				...
				.texOffs(10, 19).addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.0F, 0.0F));
		...
		PartDefinition handle = aquamarine_sword.addOrReplaceChild("handle", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -22.0F, -3.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
				...
				.texOffs(24, 15).addBox(2.0F, -22.0F, -2.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 15.0F, 0.0F));
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(((AquamarineSwordEntity) entity).attackAnimationState, AquamarineSwordAnimationDefenition.ATTACK, ageInTicks, 1f);
	}
