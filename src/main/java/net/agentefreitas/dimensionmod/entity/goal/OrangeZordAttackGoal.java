...
public class OrangeZordAttackGoal extends MeleeAttackGoal {
    private final OrangeZordEntity entity;
    private int attackDelay = 7;
    private int ticksUntilNextAttack = 15;
    private boolean shouldCountTillNextAttack = false;

    public OrangeZordAttackGoal(TamableAnimal pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((OrangeZordEntity) pMob);
    }
